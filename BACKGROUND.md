# DEAD ZONE — Background & Knowledge Dump
...
**DEAD ZONE** is a top-down zombie survival shooter built as a single HTML file. It runs in any browser, supports up to 4 players via WebSocket multiplayer, and has full mobile touch controls. The vibe is dark, gory, frantic arcade action — pick up and play, no install, no tutorial. Think Vampire Survivors meets Hotline Miami meets Left 4 Dead, but in a browser.
